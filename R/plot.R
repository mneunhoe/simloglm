...
#' @param which_mean Which mean should be plotted? Geometric mean ("geometric_mean") or arithmetic mean ("arithmetic_mean"), defaults to "geometric_mean".
...
plot.simloglm <- function(input_obj, which_mean = "geometric_mean", alpha = 0.05, twosided = TRUE) {

    plot(input_obj[[which_mean]])
