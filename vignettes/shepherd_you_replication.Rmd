...
fd_mean_aca <- get_first_difference(results_aca_retransformed, which_qoi = "mean")


fd_median_aca <- get_first_difference(results_aca_retransformed, which_qoi = "median")
# Ratio instead of fd
