...
set.seed(20220309)
results_aca <- simloglm(m4, nsim_est = 20000, X = scenario,  observed_value_approach = F, fast = T)

set.seed(20220309)
results_ova <- simloglm(m4, nsim_est = 20000, scenario = list(futurelob = c(mean(m4$model$futurelob),mean(m4$model$futurelob)+sdxresid)),  observed_value_approach = T, fast = T)
```
