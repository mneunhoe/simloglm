...
plot(fd$fd, 1, ylim = c(0.5, 2.5), xlim = c(-0.5,1.2), yaxt = "n",xaxt = "n", xlab = "", bty = "n", ylab = "", type = "n")
box(lty = "solid", col = "grey50")
...
mtext(3,
      ...
      line = 0.4)
segments(x0 = seq(-0.5, 1, 0.25), y0 = 0.43, y1 = 2.57,  lty = "dashed", col = "grey90")
segments(x0 = fd$quantiles[1], x1 = fd$quantiles[2], y0 = 1, lwd = 4, lend = 1, col = viridis::viridis(2)[1])
points(fd$fd, 1, pch = 124, col = "white")
segments(x0 = fd_extreme$quantiles[1], x1 = fd_extreme$quantiles[2], y0 = 2, lwd = 4, lend = 1, col = viridis::viridis(2)[1])
points(fd_extreme$fd, 2, pch = 124, col = "white")
text(x = fd$quantiles[2], y = 1, labels = "Average Case Scenario", pos = 4)
text(x = fd_extreme$quantiles[1], y = 2, labels = "Alternative Scenario", pos = 2)
